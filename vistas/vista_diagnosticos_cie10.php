...
$mi_programa = 'vista_diagnosticos_cie10.php'; // Debe coincidir con el nombre_archivo en acc_programa
...
<head>
    ...
    <title>Diagnosticos_cie10</title>
    ...
    <div class="container pb-5">
        ...
        <div class="main-card">
            <div class="card-header-custom d-flex justify-content-between align-items-center">
                <div>
                    <h3 class="mb-0"><i class="icon-table me-2"></i> Diagnosticos_cie10</h3>
                ...
                <div class="d-flex gap-2">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow border-0">
                            <li><a class="dropdown-item" href="../controladores/controlador_diagnosticos_cie10.php?action=exportar&formato=excel&busqueda=<?php echo isset($_GET['busqueda']) ? urlencode($_GET['busqueda']) : ''; ?>&campo=<?php echo isset($_GET['campo']) ? urlencode($_GET['campo']) : ''; ?>"><i class="icon-file-excel text-success me-2"></i> Excel</a></li>
                            <li><a class="dropdown-item" href="../controladores/controlador_diagnosticos_cie10.php?action=exportar&formato=csv&busqueda=<?php echo isset($_GET['busqueda']) ? urlencode($_GET['busqueda']) : ''; ?>&campo=<?php echo isset($_GET['campo']) ? urlencode($_GET['campo']) : ''; ?>"><i class="icon-file-text text-primary me-2"></i> CSV</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="../controladores/controlador_diagnosticos_cie10.php?action=exportar&formato=txt&busqueda=<?php echo isset($_GET['busqueda']) ? urlencode($_GET['busqueda']) : ''; ?>&campo=<?php echo isset($_GET['campo']) ? urlencode($_GET['campo']) : ''; ?>"><i class="icon-doc-text-inv text-secondary me-2"></i> TXT</a></li>
                        </ul>
                    </div>
                    <?php endif; ?>
            ...
            <div class="card-body p-4">
                <!-- Buscador -->
                <form method="GET" action="vista_diagnosticos_cie10.php" class="mb-4">
                    <div class="input-group">
                        ...
                        <?php if(isset($_GET['busqueda']) && $_GET['busqueda'] !== ''): ?>
                            <a href="vista_diagnosticos_cie10.php" class="btn btn-outline-danger d-flex align-items-center"><i class="icon-cancel"></i></a>
                        <?php endif; ?>
                    </div>
                </form>
...
?>
                                <th>
                                    <a href="?<?php echo http_build_query(array_merge($_GET, ['sort' => "`diagnosticos_cie10`.`codigo`", 'dir' => $nextDir])); ?>" class="text-decoration-none text-muted">
                                        codigo                                        <?php if (str_replace(['`',' '], '', $sort) === str_replace(['`',' '], '', "`diagnosticos_cie10`.`codigo`")): ?>                                            <i class="icon-<?php echo ($dir === 'ASC') ? 'up-dir' : 'down-dir'; ?> ms-1"></i>
                                        <?php endif; ?>                                    </a>
                                </th>
                                <th>
                                    <a href="?<?php echo http_build_query(array_merge($_GET, ['sort' => "`diagnosticos_cie10`.`descripcion`", 'dir' => $nextDir])); ?>" class="text-decoration-none text-muted">
                                        descripcion                                        <?php if (str_replace(['`',' '], '', $sort) === str_replace(['`',' '], '', "`diagnosticos_cie10`.`descripcion`")): ?>                                            <i class="icon-<?php echo ($dir === 'ASC') ? 'up-dir' : 'down-dir'; ?> ms-1"></i>
                                        <?php endif; ?>                                    </a>
                                </th>
                                <th>
                                    <a href="?<?php echo http_build_query(array_merge($_GET, ['sort' => "`diagnosticos_cie10`.`codigo_categoria`", 'dir' => $nextDir])); ?>" class="text-decoration-none text-muted">
                                        codigo_categoria                                        <?php if (str_replace(['`',' '], '', $sort) === str_replace(['`',' '], '', "`diagnosticos_cie10`.`codigo_categoria`")): ?>                                            <i class="icon-<?php echo ($dir === 'ASC') ? 'up-dir' : 'down-dir'; ?> ms-1"></i>
                                        <?php endif; ?>                                    </a>
                                </th>
                                <th>
                                    <a href="?<?php echo http_build_query(array_merge($_GET, ['sort' => "`diagnosticos_cie10`.`categoria`", 'dir' => $nextDir])); ?>" class="text-decoration-none text-muted">
                                        categoria                                        <?php if (str_replace(['`',' '], '', $sort) === str_replace(['`',' '], '', "`diagnosticos_cie10`.`categoria`")): ?>                                            <i class="icon-<?php echo ($dir === 'ASC') ? 'up-dir' : 'down-dir'; ?> ms-1"></i>
                                        <?php endif; ?>                                    </a>
                                </th>
                                <th>
                                    <a href="?<?php echo http_build_query(array_merge($_GET, ['sort' => "`diagnosticos_cie10`.`estado`", 'dir' => $nextDir])); ?>" class="text-decoration-none text-muted">
                                        estado                                        <?php if (str_replace(['`',' '], '', $sort) === str_replace(['`',' '], '', "`diagnosticos_cie10`.`estado`")): ?>                                            <i class="icon-<?php echo ($dir === 'ASC') ? 'up-dir' : 'down-dir'; ?> ms-1"></i>
                                        <?php endif; ?>                                    </a>
                                </th>
                        ...
                        <tbody>
                            <?php
                            require_once '../modelos/modelo_diagnosticos_cie10.php';
                            ...
                            $modelo = new ModeloDiagnosticos_cie10();
                            $modeloLog = new ModeloAcc_log();
                            $modeloLog->registrar($_SESSION['usuario_id'] ?? 0, 'VIEW', 'diagnosticos_cie10', 'Acceso a la pantalla de listado');
                ...
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($registro['codigo_categoria']); ?></td>
                    ...
                    <td class="text-center">
                        ...
                        <button type="button" class="btn btn-sm btn-outline-warning" data-bs-toggle="modal" data-bs-target="#modalActualizar" data-idActualizar="<?php echo $registro['id']; ?>"
                           ...
                           data-codigo_categoria="<?php echo htmlspecialchars($registro['codigo_categoria']); ?>"
                           data-categoria="<?php echo htmlspecialchars($registro['categoria']); ?>"
                     ...
                     <div class="modal-header">
                         <div class="row">
                             <div class="form-group col-md-8">
                               <h5 class="modal-title">Actualizar Diagnosticos_cie10 - ID: </h5>
                             </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('formCrear').addEventListener('submit', function(e) {
                ...
                fetch('../controladores/controlador_diagnosticos_cie10.php?action=crear', {
                    method: 'POST',
            ...
            modalActualizarElement.addEventListener('show.bs.modal', function(event) {
                ...
                var valorcodigo_categoria = button.getAttribute('data-codigo_categoria');
                var inputcodigo_categoria = modal.querySelector('#codigo_categoria');
                if(inputcodigo_categoria) {
                    if (inputcodigo_categoria.type === 'checkbox') {
                        inputcodigo_categoria.checked = (valorcodigo_categoria === 'activo');
                    } else {
                        inputcodigo_categoria.value = valorcodigo_categoria;
                    }
                }
                var valorcategoria = button.getAttribute('data-categoria');
                var inputcategoria = modal.querySelector('#categoria');
                if(inputcategoria) {
                    if (inputcategoria.type === 'checkbox') {
                        inputcategoria.checked = (valorcategoria === 'activo');
                    } else {
                        inputcategoria.value = valorcategoria;
                    }
                }
            ...
            document.getElementById('formActualizar').addEventListener('submit', function(e) {
                e.preventDefault();
                const formData = new FormData(this);
                fetch('../controladores/controlador_diagnosticos_cie10.php?action=actualizar', {
                    method: 'POST',
                    body: new URLSearchParams(formData)
                })
                .then(response => response.json())
        ...
        function eliminar(id) {
            if (confirm('¿Estás seguro de que deseas eliminar este registro?')) {
                fetch('../controladores/controlador_diagnosticos_cie10.php?action=eliminar', {
                    method: 'POST',
                    headers: {
