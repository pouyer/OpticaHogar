...
$mi_programa = 'vista_medicamentos.php'; // Debe coincidir con el nombre_archivo en acc_programa
    ...
    <div class="container pb-5">
        ...
        <div class="main-card">
            <div class="card-header-custom d-flex justify-content-between align-items-center">
                <div>
                    <h3 class="mb-0"><i class="icon-table me-2"></i> Medicamentos</h3>
                ...
                <div class="d-flex gap-2">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow border-0">
                            <li><a class="dropdown-item" href="../controladores/controlador_medicamentos.php?action=exportar&formato=excel&busqueda=<?php echo isset($_GET['busqueda']) ? urlencode($_GET['busqueda']) : ''; ?>&campo=<?php echo isset($_GET['campo']) ? urlencode($_GET['campo']) : ''; ?>"><i class="icon-file-excel text-success me-2"></i> Excel</a></li>
                            <li><a class="dropdown-item" href="../controladores/controlador_medicamentos.php?action=exportar&formato=csv&busqueda=<?php echo isset($_GET['busqueda']) ? urlencode($_GET['busqueda']) : ''; ?>&campo=<?php echo isset($_GET['campo']) ? urlencode($_GET['campo']) : ''; ?>"><i class="icon-file-text text-primary me-2"></i> CSV</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="../controladores/controlador_medicamentos.php?action=exportar&formato=txt&busqueda=<?php echo isset($_GET['busqueda']) ? urlencode($_GET['busqueda']) : ''; ?>&campo=<?php echo isset($_GET['campo']) ? urlencode($_GET['campo']) : ''; ?>"><i class="icon-doc-text-inv text-secondary me-2"></i> TXT</a></li>
                        </ul>
                    </div>
                    <?php endif; ?>
            ...
            <div class="card-body p-4">
                <!-- Buscador -->
                <form method="GET" action="vista_medicamentos.php" class="mb-4">
                    <div class="input-group">
                        ...
                        <?php if(isset($_GET['busqueda']) && $_GET['busqueda'] !== ''): ?>
                            <a href="vista_medicamentos.php" class="btn btn-outline-danger d-flex align-items-center"><i class="icon-cancel"></i></a>
                        <?php endif; ?>
                    </div>
                </form>
...
?>
                                <th>
                                    <a href="?<?php echo http_build_query(array_merge($_GET, ['sort' => "`medicamentos`.`nombre`", 'dir' => $nextDir])); ?>" class="text-decoration-none text-muted">
                                        nombre                                        <?php if (str_replace(['`',' '], '', $sort) === str_replace(['`',' '], '', "`medicamentos`.`nombre`")): ?>                                            <i class="icon-<?php echo ($dir === 'ASC') ? 'up-dir' : 'down-dir'; ?> ms-1"></i>
                                        <?php endif; ?>                                    </a>
                                </th>
                                <th>
                                    <a href="?<?php echo http_build_query(array_merge($_GET, ['sort' => "`medicamentos`.`principio_activo`", 'dir' => $nextDir])); ?>" class="text-decoration-none text-muted">
                                        principio_activo                                        <?php if (str_replace(['`',' '], '', $sort) === str_replace(['`',' '], '', "`medicamentos`.`principio_activo`")): ?>                                            <i class="icon-<?php echo ($dir === 'ASC') ? 'up-dir' : 'down-dir'; ?> ms-1"></i>
                                        <?php endif; ?>                                    </a>
                                </th>
                                <th>
                                    <a href="?<?php echo http_build_query(array_merge($_GET, ['sort' => "`medicamentos`.`concentracion`", 'dir' => $nextDir])); ?>" class="text-decoration-none text-muted">
                                        concentracion                                        <?php if (str_replace(['`',' '], '', $sort) === str_replace(['`',' '], '', "`medicamentos`.`concentracion`")): ?>                                            <i class="icon-<?php echo ($dir === 'ASC') ? 'up-dir' : 'down-dir'; ?> ms-1"></i>
                                        <?php endif; ?>                                    </a>
                                </th>
                                <th>
                                    <a href="?<?php echo http_build_query(array_merge($_GET, ['sort' => "`medicamentos`.`presentacion`", 'dir' => $nextDir])); ?>" class="text-decoration-none text-muted">
                                        presentacion                                        <?php if (str_replace(['`',' '], '', $sort) === str_replace(['`',' '], '', "`medicamentos`.`presentacion`")): ?>                                            <i class="icon-<?php echo ($dir === 'ASC') ? 'up-dir' : 'down-dir'; ?> ms-1"></i>
                                        <?php endif; ?>                                    </a>
                                </th>
                                <th>
                                    <a href="?<?php echo http_build_query(array_merge($_GET, ['sort' => "`medicamentos`.`via_administracion`", 'dir' => $nextDir])); ?>" class="text-decoration-none text-muted">
                                        via_administracion                                        <?php if (str_replace(['`',' '], '', $sort) === str_replace(['`',' '], '', "`medicamentos`.`via_administracion`")): ?>                                            <i class="icon-<?php echo ($dir === 'ASC') ? 'up-dir' : 'down-dir'; ?> ms-1"></i>
                                        <?php endif; ?>                                    </a>
                                </th>
                                <th>
                                    <a href="?<?php echo http_build_query(array_merge($_GET, ['sort' => "`medicamentos`.`indicaciones`", 'dir' => $nextDir])); ?>" class="text-decoration-none text-muted">
                                        indicaciones                                        <?php if (str_replace(['`',' '], '', $sort) === str_replace(['`',' '], '', "`medicamentos`.`indicaciones`")): ?>                                            <i class="icon-<?php echo ($dir === 'ASC') ? 'up-dir' : 'down-dir'; ?> ms-1"></i>
                                        <?php endif; ?>                                    </a>
                                </th>
                                <th>
                                    <a href="?<?php echo http_build_query(array_merge($_GET, ['sort' => "`medicamentos`.`contraindicaciones`", 'dir' => $nextDir])); ?>" class="text-decoration-none text-muted">
                                        contraindicaciones                                        <?php if (str_replace(['`',' '], '', $sort) === str_replace(['`',' '], '', "`medicamentos`.`contraindicaciones`")): ?>                                            <i class="icon-<?php echo ($dir === 'ASC') ? 'up-dir' : 'down-dir'; ?> ms-1"></i>
                                        <?php endif; ?>                                    </a>
                                </th>
                                <th>
                                    <a href="?<?php echo http_build_query(array_merge($_GET, ['sort' => "`medicamentos`.`estado`", 'dir' => $nextDir])); ?>" class="text-decoration-none text-muted">
                                        estado                                        <?php if (str_replace(['`',' '], '', $sort) === str_replace(['`',' '], '', "`medicamentos`.`estado`")): ?>                                            <i class="icon-<?php echo ($dir === 'ASC') ? 'up-dir' : 'down-dir'; ?> ms-1"></i>
                                        <?php endif; ?>                                    </a>
                                </th>
                        ...
                        <tbody>
                            <?php
                            require_once '../modelos/modelo_medicamentos.php';
                            ...
                            $modeloLog->registrar($_SESSION['usuario_id'] ?? 0, 'VIEW', 'medicamentos', 'Acceso a la pantalla de listado');
                ...
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($registro['principio_activo']); ?></td>
                    <td><?php echo htmlspecialchars($registro['concentracion']); ?></td>
                    <td><?php echo htmlspecialchars($registro['presentacion']); ?></td>
                    <td><?php echo htmlspecialchars($registro['via_administracion']); ?></td>
                    <td><?php echo htmlspecialchars($registro['indicaciones']); ?></td>
                    <td><?php echo htmlspecialchars($registro['contraindicaciones']); ?></td>
                    ...
                    <td class="text-center">
                        ...
                        <button type="button" class="btn btn-sm btn-outline-warning" data-bs-toggle="modal" data-bs-target="#modalActualizar" data-idActualizar="<?php echo $registro['id']; ?>"
                           ...
                           data-principio_activo="<?php echo htmlspecialchars($registro['principio_activo']); ?>"
                           data-concentracion="<?php echo htmlspecialchars($registro['concentracion']); ?>"
                           data-presentacion="<?php echo htmlspecialchars($registro['presentacion']); ?>"
                           data-via_administracion="<?php echo htmlspecialchars($registro['via_administracion']); ?>"
                           data-indicaciones="<?php echo htmlspecialchars($registro['indicaciones']); ?>"
                           data-contraindicaciones="<?php echo htmlspecialchars($registro['contraindicaciones']); ?>"
                    ...
                    <div class="modal-body p-4">
                        <form id="formCrear" method="post">
                            <div class="row">                                <div class="col-md-4 mb-3">
                                ...
                                <div class="col-md-4 mb-3">
                                    <label for="via_administracion">via_administracion:</label>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="contraindicaciones" name="contraindicaciones">
                                </div>
                                <div class="col-md-4 mb-3">
                     ...
                     <div class="modal-header">
                         <div class="row">
                             <div class="form-group col-md-8">
                               <h5 class="modal-title">Actualizar Medicamentos - ID: </h5>
                             </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('formCrear').addEventListener('submit', function(e) {
                ...
                fetch('../controladores/controlador_medicamentos.php?action=crear', {
                    method: 'POST',
            ...
            modalActualizarElement.addEventListener('show.bs.modal', function(event) {
                ...
                var valorprincipio_activo = button.getAttribute('data-principio_activo');
                var inputprincipio_activo = modal.querySelector('#principio_activo');
                if(inputprincipio_activo) {
                    if (inputprincipio_activo.type === 'checkbox') {
                        inputprincipio_activo.checked = (valorprincipio_activo === 'activo');
                    } else {
                        inputprincipio_activo.value = valorprincipio_activo;
                    }
                }
                var valorconcentracion = button.getAttribute('data-concentracion');
                var inputconcentracion = modal.querySelector('#concentracion');
                if(inputconcentracion) {
                    if (inputconcentracion.type === 'checkbox') {
                        inputconcentracion.checked = (valorconcentracion === 'activo');
                    } else {
                        inputconcentracion.value = valorconcentracion;
                    }
                }
                var valorpresentacion = button.getAttribute('data-presentacion');
                var inputpresentacion = modal.querySelector('#presentacion');
                if(inputpresentacion) {
                    if (inputpresentacion.type === 'checkbox') {
                        inputpresentacion.checked = (valorpresentacion === 'activo');
                    } else {
                        inputpresentacion.value = valorpresentacion;
                    }
                }
                var valorvia_administracion = button.getAttribute('data-via_administracion');
                var inputvia_administracion = modal.querySelector('#via_administracion');
                if(inputvia_administracion) {
                    if (inputvia_administracion.type === 'checkbox') {
                        inputvia_administracion.checked = (valorvia_administracion === 'activo');
                    } else {
                        inputvia_administracion.value = valorvia_administracion;
                    }
                }
                var valorindicaciones = button.getAttribute('data-indicaciones');
                var inputindicaciones = modal.querySelector('#indicaciones');
                if(inputindicaciones) {
                    if (inputindicaciones.type === 'checkbox') {
                        inputindicaciones.checked = (valorindicaciones === 'activo');
                    } else {
                        inputindicaciones.value = valorindicaciones;
                    }
                }
                var valorcontraindicaciones = button.getAttribute('data-contraindicaciones');
                var inputcontraindicaciones = modal.querySelector('#contraindicaciones');
                if(inputcontraindicaciones) {
                    if (inputcontraindicaciones.type === 'checkbox') {
                        inputcontraindicaciones.checked = (valorcontraindicaciones === 'activo');
                    } else {
                        inputcontraindicaciones.value = valorcontraindicaciones;
                    }
                }
            ...
            document.getElementById('formActualizar').addEventListener('submit', function(e) {
                e.preventDefault();
                const formData = new FormData(this);
                fetch('../controladores/controlador_medicamentos.php?action=actualizar', {
                    method: 'POST',
                    body: new URLSearchParams(formData)
                })
                .then(response => response.json())
        ...
        function eliminar(id) {
            if (confirm('¿Estás seguro de que deseas eliminar este registro?')) {
                fetch('../controladores/controlador_medicamentos.php?action=eliminar', {
                    method: 'POST',
                    headers: {
